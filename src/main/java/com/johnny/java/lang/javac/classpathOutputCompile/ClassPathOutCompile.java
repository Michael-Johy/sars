package com.johnny.java.lang.javac.classpathOutputCompile;

import com.johnny.java.lang.javac.cases.Constants;
import com.johnny.java.lang.javac.common.StringSourceJavaFileObject;
...
public class ClassPathOutCompile {
    ...
    public void compiler() throws Exception {
        ...
        standardJavaFileManager.setLocation(StandardLocation.CLASS_OUTPUT, Collections.singletonList(new File("/Users/johnny/codes/github/utils-utils/bytes/")));
        ...
        try {
            ...
            Writer log = new PrintWriter(new FileOutputStream("/Users/johnny/codes/github/utils-utils/bytes/compile_log"), true);
