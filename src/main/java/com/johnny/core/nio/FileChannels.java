...
//        test1();
    ...
    private static void test1() throws IOException {
        RandomAccessFile file = new RandomAccessFile("/Users/johnny/codes/github/sars-utils/src/main/resources/filechannel_test", "rw");
    ...
    private static void transfer() throws Exception {
        RandomAccessFile file = new RandomAccessFile("/Users/johnny/codes/github/sars-utils/src/main/resources/tofilechannel_test", "rw");
        FileChannel toChannel = file.getChannel();

        RandomAccessFile fromFile = new RandomAccessFile("/Users/johnny/codes/github/sars-utils/src/main/resources/filechannel_test", "rw");
